...
Marine text formatting is fixed to `SOG` in rounded whole knots and `COG` with a degree symbol and 8-way cardinal label. Missing AIS values are rendered as `--`.
